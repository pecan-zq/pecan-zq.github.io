i18n.append({
  ...
  '#robot-IgniterLong#': {
    en:
      '<p>This robot is equipped with two color sensors for line following.</p>' +
      '<p>A motor is also equipped to allow the arm of the robot to move and perform simple tasks.</p>' +
      '<p>It\'s good for learning the basics of line following.</p>',
    fr:
      '',
    de:
      '',
...
var robotTemplates = [
  {
    name: 'IgniterBot',
    shortDescription: '#robot-IgniterShort#',
    longDescription: '#robot-IgniterLong#',
    longerDescription:
